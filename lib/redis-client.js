...
// TODO: This is not unit tested yet!!!
...
if (process.env.REDIS_HOST && process.env.REDIS_PORT) {
  ...
  // it violates JSON synxtax, hence assign to intermediary variables and then deference those in the JSON literal farther below
